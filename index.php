...
$someNumber = 5; // les variables s'écrivent avec un $ suivi d'un nom qui décrit ce qu'elles contiennent écrit en camelCase
...
echo $someText .= $someNumber . ' et on peut toujours dire que' . SOME_CONSTANT;
...
Nous avons déjà vu le '+' dans l'exemple ligne 36, auquel il faut ajouter:
moins: -
multiplier: *
diviser: /
...
// ATTENTION: Cela ne veut pas dire qu'on ne peut pas faire d eboucle infinie avec for
